...
class TestTradingBot:
    ...
    def test_market_data_processing(self, mock_bybit, mock_deepseek):
        ...
        mock_bybit_instance.get_market_data.return_value = {
            ...
            'volume_24h': 10000000,
            'historical': 'Тестовые исторические данные'
        }
...
def test_bybit_client_directly():
    """Прямой тест клиента Bybit (только если есть API ключи)"""
    import os
    ...
    # Тестируем получение данных (только если ключи есть)
